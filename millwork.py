...
st.markdown("""
    <style>
    .event-box {width: 250px; height: 250px; border-radius:16px; display:flex; justify-content:center; align-items:center; margin:10px; float:left; background-color:#FF6A00; color:black; font-weight:bold; font-size:18px; text-align:center;}
    ...
    if ticket_id_to_check:
        ...
        if ticket:
            ...
            if ticket["status"] == "valid":
                if st.button(f"Redeem Ticket {ticket_id_to_check}"):
